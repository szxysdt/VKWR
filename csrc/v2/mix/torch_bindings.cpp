...
std::vector<torch::Tensor> tmix_mix6_fn(
    ...
    torch::Tensor x, torch::Tensor slot_indices, torch::Tensor shift_state,
  ...
  return tmix_mix6_cuda(
      ...
      x, slot_indices, shift_state, x_r, x_w, x_k, x_v, x_a, x_g);
}
...
std::vector<torch::Tensor> tmix_mix6_cfg_fn(
  ...
  return tmix_mix6_cfg_cuda(
      static_cast<int>(B), static_cast<int>(T), static_cast<int>(C),
      x, slot_indices, shift_state, x_r, x_w, x_k, x_v, x_a, x_g, static_cast<int>(threads));
}
...
std::vector<torch::Tensor> tmix_kk_a_gate_fn(
  ...
  return tmix_kk_a_gate_cuda(
      ...
      k, k_k, a0, a12, k_a, k, torch::Tensor(), torch::Tensor(), false);
}
...
std::vector<torch::Tensor> tmix_kk_a_gate_update_shift_fn(
  ...
  return tmix_kk_a_gate_cuda(
      static_cast<int>(B), static_cast<int>(T), static_cast<int>(C), static_cast<int>(H),
      k, k_k, a0, a12, k_a, x, slot_indices, shift_state, true);
}
...
torch::Tensor cmix_sparse_one_fn(
    int64_t C, int64_t F,
    torch::Tensor x, torch::Tensor slot_indices, torch::Tensor shift_state, torch::Tensor x_k,
  ...
  return cmix_sparse_one_cuda(
      static_cast<int>(C), static_cast<int>(F), x, slot_indices, shift_state, x_k, key_fc, value_fc);
}
...
torch::Tensor cmix_sparse_rows_fn(
  ...
  return cmix_sparse_rows_cuda(
      ...
      x, slot_indices, shift_state, x_k, key_fc, value_fc);
}
...
torch::Tensor cmix_mix_fn(
  ...
  return cmix_mix_cuda(
      static_cast<int>(B), static_cast<int>(T), static_cast<int>(C), x, slot_indices, shift_state, x_k);
}
...
torch::Tensor cmix_mix_cfg_fn(
  ...
  return cmix_mix_cfg_cuda(
      static_cast<int>(B), static_cast<int>(T), static_cast<int>(C), x, slot_indices, shift_state, x_k, static_cast<int>(threads));
}
...
TORCH_LIBRARY(vkwr_v2_mix, m) {
  m.def("tmix_mix6(int B, int T, int C, Tensor x, Tensor slot_indices, Tensor(a!) shift_state, "
      "Tensor x_r, Tensor x_w, Tensor x_k, Tensor x_v, Tensor x_a, Tensor x_g) -> Tensor[]");
  m.impl("tmix_mix6", c10::kCUDA, &tmix_mix6_fn);

  m.def("tmix_mix6_cfg(int B, int T, int C, Tensor x, Tensor slot_indices, Tensor(a!) shift_state, "
  ...
  m.def("tmix_mix6_t1_c4096(int B, Tensor x, Tensor slot_indices, Tensor(a!) shift_state, "
  ...
  m.def("tmix_kk_a_gate_update_shift(int B, int T, int C, int H, Tensor k, Tensor k_k, Tensor a0, Tensor a12, Tensor k_a, Tensor x, Tensor slot_indices, Tensor(a!) shift_state) -> Tensor[]");
  ...
  m.def("cmix_sparse_one(int C, int F, Tensor x, Tensor slot_indices, Tensor(a!) shift_state, Tensor x_k, Tensor key_fc, Tensor value_fc) -> Tensor");
  m.impl("cmix_sparse_one", c10::kCUDA, &cmix_sparse_one_fn);

  m.def("cmix_sparse_rows(int B, int T, int C, int F, Tensor x, Tensor slot_indices, Tensor(a!) shift_state, Tensor x_k, Tensor key_fc, Tensor value_fc) -> Tensor");
  ...
  m.def("cmix_mix(int B, int T, int C, Tensor x, Tensor slot_indices, Tensor(a!) shift_state, Tensor x_k) -> Tensor");
  m.impl("cmix_mix", c10::kCUDA, &cmix_mix_fn);

  m.def("cmix_mix_cfg(int B, int T, int C, Tensor x, Tensor slot_indices, Tensor(a!) shift_state, Tensor x_k, int threads) -> Tensor");
