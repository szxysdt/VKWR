...
std::vector<at::Tensor> tmix_mix6_cuda(
    int B, int T, int C,
    at::Tensor x, at::Tensor slot_indices, at::Tensor shift_state,
...
std::vector<at::Tensor> tmix_kk_a_gate_cuda(
    ...
    at::Tensor x, at::Tensor slot_indices, at::Tensor shift_state, bool update_shift);
...
at::Tensor cmix_sparse_one_cuda(
    int C, int F,
    at::Tensor x, at::Tensor slot_indices, at::Tensor shift_state, at::Tensor x_k, at::Tensor key_fc, at::Tensor value_fc);
...
at::Tensor cmix_mix_cuda(
    int B, int T, int C,
    at::Tensor x, at::Tensor slot_indices, at::Tensor shift_state, at::Tensor x_k);

at::Tensor cmix_mix_cfg_cuda(
    int B, int T, int C,
    at::Tensor x, at::Tensor slot_indices, at::Tensor shift_state, at::Tensor x_k, int threads);
